...
export const Technologies = () => {
  return (
    <div className="grid grid-cols-1 mx-5 mt-10">
      ...
      <div className="grid justify-center grid-cols-5 gap-10">
        <div>
          {" "}
          <img src={Laravel} alt="Laravel Logo" className="w-12 h-12" />
        </div>
        <div>
          {" "}
        ...
        <div>
          {" "}
          <img src={Mysql} alt="Mysql Logo" className="w-12 h-12" />
        </div>
        <div>
          {" "}
        ...
        <div>
          {" "}
          <img src={Typescript} alt="Typescript Logo" className="w-12 h-12" />
        </div>
        <div>
          {" "}
          <img src={Vite} alt="Vite Logo" className="w-12 h-12" />
        </div>
      </div>
    </div>
  );
